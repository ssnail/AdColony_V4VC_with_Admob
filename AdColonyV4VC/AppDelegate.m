...
#ifdef DEBUG
#define TEST_STR @"is_debug"
#else
#define TEST_STR @"is_not_debug"
#endif
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	[AdColony configureWithAppID:@"app85b57b1a6000443592" zoneIDs:@[@"vz3645c12ae95b4e47ab"] delegate:self logging:YES];
